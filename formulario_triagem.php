...
<html lang="pt-br">
  <head>
    ...
    <title>Portal NATA-BA - Formulario de triagem</title>
...
<header class="cabecalho">
    ...
    <section>
      <div class="container">
        <h2>Solicitar triagem</h2>
        <form method="POST" action="enviar_form.php">
          <div class="row mb-3">
            <div class="col-md-4">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-4">
              ...
              <select class="form-select" id="reclamacao" name="reclamacao" required>
              <option value="">Selecione a reclamação</option>
            ...
            <div class="col-md-4">
              ...
              <option value="">Selecione a posto</option>
              <option value="INOPERANTE">CLD</option>
              <option value="INTERMITENTE">CLDV</option>
            </select>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="emissor" name="emissor" required>
          </div>
